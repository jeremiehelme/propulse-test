...
function acfgfs_google_font_enqueue()
{
    ...
    foreach ($fonts as $font) {
        if (is_array($font) && array_key_exists('subsets', $font) && !empty($font['subsets'])) {
        ...
        if ($font['variants'] == array('regular')) {
            ...
            if (is_array($font) && array_key_exists('variants', $font) && !empty($font['variants'])) {
...
function acfgfs_get_fonts()
{
    ...
    //force to use the static font-list instead of default or google fonts
    $fonts = "";
