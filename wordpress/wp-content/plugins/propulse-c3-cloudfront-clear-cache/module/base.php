...
class C3_Base {
	...
	public static function get_access_key() {
		if(defined('AS3CF_AWS_ACCESS_KEY_ID')) {
			return AS3CF_AWS_ACCESS_KEY_ID;
		} else {
	...
	public static function get_secret_key() {
		if(defined('AS3CF_AWS_SECRET_ACCESS_KEY')) {
			return AS3CF_AWS_SECRET_ACCESS_KEY;
		} else {
	...
	public static function are_key_constants_set() {
		return defined( 'AS3CF_AWS_ACCESS_KEY_ID' ) && defined( 'AS3CF_AWS_SECRET_ACCESS_KEY' );
	}
